...
public class ObjectMultistackDemo {
	public static void main(String[] args) {
		...
		multistack.push("year", new ValueWrapper(Integer.valueOf(3000)));
		...
		multistack.peek("year").subtract(15.0);
		System.out.println("Current value for year: " + multistack.peek("year").getValue());
		
		multistack.peek("year").divide(2.0);
		System.out.println("Current value for year: " + multistack.peek("year").getValue());
		
		multistack.peek("year").multiply(2.0);
		System.out.println("Current value for year: " + multistack.peek("year").getValue());
		
		System.out.println(multistack.peek("year").numCompare(1999.0));
		System.out.println("Current value for year: " + multistack.peek("year").getValue());
	}
}
